...
| On run program enter password greater then 20 characters                                    | Enter password of greater then 20 characters               | Error message appear greater 18 characters input and exit the program                                                                                                                 | pass   |
...
| Enter new master password less of 3 characters                                                   | Enter password of less then 3 characters                   | Error message appear lesser then 3 characters input and 'Press Enter' for redirect to main menu                                                                                              | pass   |
