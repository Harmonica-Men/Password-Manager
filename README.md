...
| On run program enter password less then 4 charaters                                        | Enter password of less then 4 characters                   | Error message appear < 4 char input and exit the program                                                                                                                  | pass   |
