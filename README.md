...
| On run program enter password less then 4 charaters                                        | enter password od less then 4 chars                   | error message appear < 4 char input and exit the program                                                                                                                  | pass   |
| On run program enter password greater then 20 charaters                                    | enter password od greater then 20 chars               | error message appear > 18 char input and exit the program                                                                                                                 | pass   |
| Master password enterie – unknow password                                                  | Enter a valid master password                         | the Main option menu appears                                                                                                                                              | PASS   |
| Master password enterie – know password                                                    | Enter a invalid master password                       | A error message appears that the input of the Master Password was incorrect then programs stops                                                                           | Pass   |
| Site creation enterie – less 4 char                                                        | Enter a input of less of 4 char                       | A error message appears that the input of the Site or platform was incorrect and continues whit the default                                                               | pass   |
| Site creation enterie – greater 18 char                                                    | Enter a input of greater of 18 char                   | A error message appears that the input of the Site or platform was incorrect and continues whit the default                                                               | pass   |
| Site creation enterie – between 4 and 18 char                                              | Enter a valid site enter                              | Continues to login credentials input field                                                                                                                                | pass   |
| Main Menu option choice when exceeds between 1 and 7 or letters are given                  | Enter a invalid Menu option choice                    | A error message appears that a invalid choice is given, Press Enter to redirect to main Menu                                                                              | Pass   |
...
| Create a new non-existence site or platfrom                                                | the program checks if the site is completely new      | The login option appears                                                                                                                                                  | pass   |
| When a new site is entered – less 4 characters                                             | Enter a input of less of 4 char                       | A error message appears that informs the user the inputed data is too big and after pressing enter redireted to the main option menu.                                     | pass   |
| When a new site is entered - greater 18 characters                                         | Enter a input of greater of 18 char                   | A error message appears that informs the user the inputed data is too big and after pressing enter redireted to the main option menu.                                     | pass   |
| When a new site is entered – between 4 and 15 char                                         | Enter a valid site enter                              | The password entery option appears                                                                                                                                        | pass   |
| Auto-generate password when press enter                                                    | press Enter                                           | A confirmation message appear that password is successfully added to the password list - press enter to redirected to main men                                            | pass   |
| enter manualy new password – less than 6 char                                              | Enter a input of less of 6 char                       | A error message appears that informs the user the inputed data is too big and will be auto-generate – after pressing enter redireted to the main option menu              | pass   |
| enter manualy new password – greater than 20 char                                          | Enter a input of greater of 20 char                   | A error message appears that informs the user the inputed data is too big and wll be auto-generated - after pressing enter redireted to the main option menu.             | pass   |
| enter manualy new password – between 6 and 20 char                                         | Enter a valid site enter                              | The password entery option appears                                                                                                                                        | pass   |
| Choose Main Menu option 2. Lists passwords                                                 | Enter number 2 as menu option                         | Menu option 2 appears                                                                                                                                                     | pass   |
| List passwords when the actual spreadsheet is empty or contain no data                     | Enter something                                       | A error message appears that informs the list is empty - after pressing enter redireted to the main option menu.                                                          | pass   |
| The choice of the password lising are letters                                              | enter random string that’s neither ‘n’,’N’ or ‘Y’,’y' | Listing of accounts and passwords unencrypted whit index numbers - press enter to redirect main menu                                                                      | pass   |
| Choice pasword listing wheter or not make passwords readable during listing – Yes          | Enter Y or Yes in capital                             | Listing of accounts and passwords unencrypted whit index numbers - press enter to redirect main menu                                                                      | pass   |
| Choice password listing wheter or not make passwords readable during listing – No or enter | Enter N or n or Enter                                 | Listing of accounts and passwords encrypted whit index numbers press enter to redirect main menu                                                                          | pass   |
| Choose Main Menu option 3. Set cipher key                                                  | Enter number 3 as menu option 3                       | Enter input field to enter new cipher key                                                                                                                                 | pass   |
| enter new cipher key – greater than 8 char                                                 | Enter a input of greater of 8 char                    | A error message appears that informs the user the inputed data is too big and wll be auto-generated - after pressing enter redireted to the main option menu.             | pass   |
| enter new cipher key – press enter                                                         | input field press enter                               | A error message appears that informs the user the inputed data is empty and old cipher will be still be used after pressing enter redireted to the main option menu.      | pass   |
| enter new cipher key – between 1 and 8 char                                                | Enter a valid cipher key                              | A confirmation message appear that password is successfully modyfied the cipher key and press enter to redirected to main menu                                            | pass   |
| Choose Main Menu option 4. delete a record in password list                                | input field press enter                               | A error message appears that informs the user the inputed empty index numer to delete and redireted to the main option menu.                                              | pass   |
| To be deleteted index number is 0                                                          | input field is zero                                   | A error message appears that informs the user the inputed index is zero and there are no records kept there, nothing is deleted and redirects to main menu                | pass   |
| To be Deleted index number exceeds the maximum numbers of records                          | input number higher of maximum numbers of records     | A error message appears that informs the user the inputed index exceeds the maximun number of records nothing is deleted and redirects to main menu                       | pass   |
| To be deleted index input are letters instead of number                                    | input some random string                              | A error message appears that informs the user the inputed index is invalid and nothing is deleted and redirects to main menu                                              | pass   |
| Choose Main Menu option 5. change default user login                                       | press enter in menu option 5                          | Menu option 5 appears                                                                                                                                                     | pass   |
| Enter new default user login                                                               | press Enter or empty field                            | A error message appears that informs the user the inputed empty field and redireted to the main option menu.                                                              | pass   |
| Enter new default user login – greater then 25 char                                        | Enter a input of greater of 25 char                   | A error message appears that the input of the default user exceed the max of 25 char was incorrect and continues whit the default user login to b redirected to main menu | pass   |
...
| Enter new master password                                                                  | press Enter or empty field                            | because this is a demo version when press enter a confirmation appears to acknoweledgement to bypass the password is granted                                              | pass   |
...
| Choose Main Menu option 7. Quit                                                            | Enter number 7 to quit                                | Program stops immedatly and presents a goodby message                                                                                                                     | pass   |
